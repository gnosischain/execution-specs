...
[rh]: ref:ethereum.forks.bpo5.blocks.Header.requests_hash
[dt]: ref:ethereum.forks.bpo5.requests.DEPOSIT_REQUEST_TYPE
[wt]: ref:ethereum.forks.bpo5.requests.WITHDRAWAL_REQUEST_TYPE
[ct]: ref:ethereum.forks.bpo5.requests.CONSOLIDATION_REQUEST_TYPE
[pd]: ref:ethereum.forks.bpo5.requests.parse_deposit_requests
[crh]: ref:ethereum.forks.bpo5.requests.compute_requests_hash
[pgpr]: ref:ethereum.forks.bpo5.fork.process_general_purpose_requests
"""
...
def parse_deposit_requests(block_output: BlockOutput) -> Bytes:
    ...
    [addr]: ref:ethereum.forks.bpo5.requests.DEPOSIT_CONTRACT_ADDRESS
    [sig]: ref:ethereum.forks.bpo5.requests.DEPOSIT_EVENT_SIGNATURE_HASH
    [dt]: ref:ethereum.forks.bpo5.requests.DEPOSIT_REQUEST_TYPE
    """
