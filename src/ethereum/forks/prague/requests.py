...
[rh]: ref:ethereum.forks.prague.blocks.Header.requests_hash
[dt]: ref:ethereum.forks.prague.requests.DEPOSIT_REQUEST_TYPE
[wt]: ref:ethereum.forks.prague.requests.WITHDRAWAL_REQUEST_TYPE
[ct]: ref:ethereum.forks.prague.requests.CONSOLIDATION_REQUEST_TYPE
[pd]: ref:ethereum.forks.prague.requests.parse_deposit_requests
[crh]: ref:ethereum.forks.prague.requests.compute_requests_hash
[pgpr]: ref:ethereum.forks.prague.fork.process_general_purpose_requests
"""
...
def parse_deposit_requests(block_output: BlockOutput) -> Bytes:
    ...
    [addr]: ref:ethereum.forks.prague.requests.DEPOSIT_CONTRACT_ADDRESS
    [sig]: ref:ethereum.forks.prague.requests.DEPOSIT_EVENT_SIGNATURE_HASH
    [dt]: ref:ethereum.forks.prague.requests.DEPOSIT_REQUEST_TYPE
    """
