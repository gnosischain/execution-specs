...
class Header:
    ...
    [logs bloom]: ref:ethereum.forks.constantinople.bloom.logs_bloom
    """
    ...
    ref:ethereum.forks.constantinople.fork.calculate_block_difficulty
    """
    ...
    [v]: ref:ethereum.forks.constantinople.fork.validate_proof_of_work
    """
...
class Block:
    ...
    [`header`]: ref:ethereum.forks.constantinople.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.forks.constantinople.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.forks.constantinople.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.forks.constantinople.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.forks.constantinople.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.forks.constantinople.vm.instructions.log.log4
    """
