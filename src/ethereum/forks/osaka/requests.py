...
[rh]: ref:ethereum.forks.osaka.blocks.Header.requests_hash
[dt]: ref:ethereum.forks.osaka.requests.DEPOSIT_REQUEST_TYPE
[wt]: ref:ethereum.forks.osaka.requests.WITHDRAWAL_REQUEST_TYPE
[ct]: ref:ethereum.forks.osaka.requests.CONSOLIDATION_REQUEST_TYPE
[pd]: ref:ethereum.forks.osaka.requests.parse_deposit_requests
[crh]: ref:ethereum.forks.osaka.requests.compute_requests_hash
[pgpr]: ref:ethereum.forks.osaka.fork.process_general_purpose_requests
"""
...
def parse_deposit_requests(block_output: BlockOutput) -> Bytes:
    ...
    [addr]: ref:ethereum.forks.osaka.requests.DEPOSIT_CONTRACT_ADDRESS
    [sig]: ref:ethereum.forks.osaka.requests.DEPOSIT_EVENT_SIGNATURE_HASH
    [dt]: ref:ethereum.forks.osaka.requests.DEPOSIT_REQUEST_TYPE
    """
