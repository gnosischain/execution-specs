...
class Header:
    ...
    [logs bloom]: ref:ethereum.forks.berlin.bloom.logs_bloom
    """
    ...
    ref:ethereum.forks.berlin.fork.calculate_block_difficulty
    """
    ...
    [v]: ref:ethereum.forks.berlin.fork.validate_proof_of_work
    """
...
class Block:
    ...
    [`header`]: ref:ethereum.forks.berlin.blocks.Header
    """
    ...
    [headers]: ref:ethereum.forks.berlin.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.forks.berlin.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.forks.berlin.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.forks.berlin.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.forks.berlin.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.forks.berlin.vm.instructions.log.log4
    """
